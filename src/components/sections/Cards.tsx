    ...
    <div className="bg-black">
      <div className="container mx-auto py-12 px-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          {/* Card 3 - Larger Card */}
          <div className="p-8  rounded-lg shadow-md flex flex-col gap-4  col-span-1 md:col-span-2 lg:col-span-1 row-span-2 bg-[#1D1E20] ">
            <div className="flex flex-col items-start gap-2">
          ...
          {/* Card 4 - Larger Card */}
          <div className="p-8  rounded-lg shadow-md flex flex-col gap-4 col-span-1 lg:col-span-2 bg-[#1D1E20] ">
